...
<html lang="ar" dir="rtl">
    ...
    <body class="font-sans antialiased">
        <div
            id="nav-progress"
            class="pointer-events-none fixed inset-x-0 top-0 z-[60] h-0.5 origin-right scale-x-0 bg-brand-600 transition-transform duration-300"
            aria-hidden="true"
        ></div>
        ...
        <div class="surface-page" x-data="{ sidebarOpen: false }">
            <div class="min-h-screen lg:flex">
                ...
                <aside
                    class="fixed inset-y-0 start-0 z-50 flex w-64 translate-x-full flex-col border-e border-slate-200 bg-white transition-transform duration-200 lg:static lg:translate-x-0"
