<x-app-layout>
    ...
    >
        ...
        <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <x-quick-link href="{{ route('teacher.students') }}" title="الطلاب" description="قائمة المجموعة">
            ...
            <x-quick-link href="{{ route('teacher.exams') }}" title="امتحان إلكتروني" description="بنك أسئلة">
