<div>
    ...
    <form wire:submit="save" class="space-y-4">
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">سيظهر للطلاب وأولياء الأمور عند الدفع.</p>
        </div>
        <div>
            <x-input-label value="تعليمات التحويل" />
            <textarea wire:model="paymentInstructions" rows="4" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm" placeholder="حوّل المبلغ ثم أرسل رقم العملية وصورة الإثبات..."></textarea>
        </div>
