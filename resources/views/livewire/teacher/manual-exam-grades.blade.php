<div class="space-y-5">
    ...
    <div class="grid gap-5 lg:grid-cols-2">
        <x-page-section title="إنشاء امتحان ورقي" subtitle="ارفع ورقة الامتحان (PDF/صورة) وسجّل الدرجات يدويًا بعد التصحيح.">
            <div class="space-y-4">
                <div>
        ...
        <x-page-section title="تسجيل درجة طالب" subtitle="بعد تصحيح الورقة، أدخل الدرجة يدويًا.">
            <div class="space-y-4">
                <div>
    ...
    <x-page-section title="آخر الدرجات اليدوية" subtitle="سجل الدرجات اللي سجّلتها يدويًا.">
