<div class="space-y-5">
    <x-page-section title="قائمة الطلاب" subtitle="ابحث بالاسم أو الكود، وفلتر حسب حالة الاشتراك.">
        <div class="mb-4 grid gap-3 lg:grid-cols-[1.4fr_0.8fr_auto]">
            <div>
                <x-input-label value="بحث عن طالب" />
                <x-text-input wire:model.live.debounce.300ms="search" class="mt-1.5 block w-full" placeholder="الاسم، الكود، الهاتف، أو الإيميل" />
            </div>
            <div>
                <x-input-label value="حالة الاشتراك" />
                <select wire:model.live="filter" class="mt-1.5 block w-full">
