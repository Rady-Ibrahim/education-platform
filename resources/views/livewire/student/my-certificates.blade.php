            ...
            @forelse ($certificates as $certificate)
                <div class="list-row">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('student.certificates.show', $certificate) }}" class="btn-brand">عرض / طباعة ↗</a>
                        <a href="{{ $certificate->verifyUrl() }}" class="inline-flex items-center rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-ink transition hover:bg-slate-50" rel="noopener">صفحة التحقق ↗</a>
                    </div>
                </div>
            @empty
